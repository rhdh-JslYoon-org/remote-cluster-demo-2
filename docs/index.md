...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-demo-2](https://github.com/rhdh-JslYoon-org/remote-cluster-demo-2)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-demo-2-gitops](https://github.com/rhdh-JslYoon-org/remote-cluster-demo-2-gitops)

# **Usage**

To access the remote-cluster-demo-2 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of remote-cluster-demo-2. You can access this namespace through the web console or via your CLI.
